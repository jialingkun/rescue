                    ...
                    success: function(data){                    
                        ...
                        jQuery.each(data, function(i, val) {
                            ...
                            if (typeof(element) != 'undefined' && element != null && i!=='path')
                            {
                                ...
                                if(i=='fotochild'){
                                    document.getElementById('id_child').value = val;
                                    // if(val == null || val == "--"){
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        for(loop = 0; loop < obj.data.length; loop++){
                            var a = obj.data[loop];
                            if(a.id == document.getElementById('id_child').value){
                                $('#fotochild').append('<option value="'+a.id+'" selected="">'+a.nama+'</option>');
                            }
                            else{
                        ...
                        document.getElementById("nama_child").value = nama_parent;
